    ...
    return (
        <Container>
            <Row style={{ paddingBottom: '40px' }}>
                <Col className="text-center"><h1>Wizualizacja Webowa Sterownika PLC Siemens S7-1200</h1></Col>
            </Row>
	    
	    <Row style={{ paddingBottom: '40px' }}>
		<Col className="text-center"><h3>Znajdź kombinację przełączników markerów lub przycisków na wejściu sterownika aby wywołać animację.</h3></Col>
	    </Row>
		...
		<Col><h3>M 0.7</h3></Col>
            ...
            <Row style={{ paddingBottom: '10px', paddingTop: '40px' }}>
                <Col><h2 style={{ color: 'orange' }}>Diagnostyka:</h2></Col>
            </Row>
	    <Row>
